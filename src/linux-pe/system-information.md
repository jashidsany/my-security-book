...
**Why:** docker/lxd/disk groups = root
...
**Why:** Identify targets for lateral movement
...
**Why:** Should not be world-readable
...
> Interfaces, routes, connections

**Why:** Find internal networks, pivot targets
...
**Why:** Find services running as root
