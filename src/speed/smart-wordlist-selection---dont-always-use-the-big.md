...
> 4600 entries. Catches /admin, /uploads, /backup, /config. Run this FIRST always
...
> 30000 entries. Only run if common.txt found nothing
...
> Generate wordlist FROM the site. Great for password brute force and hidden dirs
...
> Check naming convention first: try one format, if it works on SMTP/LDAP, use that format for all
