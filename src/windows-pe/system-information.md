...
> OS version, patches, architecture

**Why:** Check for missing patches
...
**Why:** SeImpersonate = potato attack
...
**Why:** Internal networks, pivot targets
...
**Why:** Outdated software with CVEs
...
**Why:** Missing KB = potential exploit
